...
VR_ERROR __stdcall coff_file_readerA(char* full_path, PVR_SECTION* code_section);
VR_ERROR __stdcall coff_file_writerA(char* full_path, PVR_SECTION code_section);
